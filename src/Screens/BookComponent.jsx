          ...
          {activeTab === "description" && (
            <div>
              ...
              <p className="text-gray-700">
                ...
                'An antiheroine able to best villainous male protagonists such
                as Patrick Bateman any day' OBSERVER 'Chilling, but also
                laugh-out-loud funny. Another corker' SUNDAY TELEGRAPH
              </p>
            </div>
          )}
        </div>
        ...
        >
          {activeTab === "author" && (
            <div>
              ...
              <p className="text-gray-700">
                Héctor García and Francesc Miralles are the coauthors of Ikigai:
                The Japanese Secret to a Long and Happy Life, an international
                bestseller published in more than forty languages. Héctor is a
                citizen of Japan, where he has lived for over a decade, and is
                the author of A Geek in Japan, a #1 bestseller in Japan.
                Francesc is the author of a number of bestselling self-help and
                inspirational books and of the novel Love in Lowercase, which
